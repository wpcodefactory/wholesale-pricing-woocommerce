...
* Dev - Fixed PHP 8.2 compatibility - "Creation of dynamic property is deprecated" notice.
* Dev - WPFactory Cross-Selling - Library updated (to v1.1.1).
...
* Dev - WPFactory Admin Menu - Library updated (to v1.0.8).
* Dev - WPFactory Recommendations - Library updated (to v1.0.6).
* Dev - Coding standards improved.
* WC tested up to: 10.3.

= 4.0.3 - 03/09/2025 =
* Fix - Admin recalculate order - HPOS compatibility.
...
* Dev - Developers - `alg_wc_ppq_price_display_by_qty_product_id` filter added.
